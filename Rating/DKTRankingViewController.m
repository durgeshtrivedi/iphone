...
#import "Players.h"
@interface DKTRankingViewController ()

@end

@implementation DKTRankingViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Players *player =[self.rankedPlayers objectAtIndex:indexPath.row];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        DKTRatePlayerViewController *ratePlayerViewController =
...
(DKTRatePlayerViewController *)controller
          didPickRatingForPlayer:(Players *)player
{
